    ...
    <body class="login">
            <div class="text-center mt-5">
                <form style="max-width: 400px;margin: auto"method="post">
                    ...
                    <input type="email" id="emailAddress" class="form-control mt-3 mb-3" name="username" placeholder="Email Address" required="required">
                    <input type="password" id="Password"  class="form-control" name="password" placeholder="Password" required="required">
                    <div class="mt-3">                
                        <button type="submit" class="btn btn-primary btn-block" formaction="UserLogin.php" value="submit_2">User Login</button>
